...
class encryption_gui():
    def __init__(self,master):
        ...
        master.title("Encryption Software")
        ...
        frame1 = Frame(master, borderwidth= 0, relief = GROOVE)
        frame1.pack(fill= "both", pady= 10)
        
        frame2 = Frame(master, borderwidth= 0, relief = GROOVE)
        ...
        frame5 = Frame(master, borderwidth= 0, relief = GROOVE)
        ...
        radio_3_4 = Radiobutton(frame4a, text = "Other", variable = self.radio_choice_4, value= 3)
        ...
        button6b = Button(frame6a, fg= "black", bg = "white", relief = RAISED, borderwidth=2, text = "Information", width =30, command = self.info)
